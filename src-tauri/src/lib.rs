...
pub fn run() {
  tauri::Builder::default()
    ...
    .invoke_handler(generate_handler![
      ...
      commands::target_download_directory,
      ...
      commands::save_global_variable,
      commands::delete_global_variable,
      ...
      commands::remove_docker_container,
