...
const en = {
  ...
  setAsStartupDirWsl: "Set current directory as this WSL terminal's startup directory",
  startupDirNeedsSavedEntry:
    'Save this terminal as a Local Terminal first to set its startup directory',
  jumpTo: 'Jump to…',
  ...
  appearanceCardSub: 'Accent colour, density, text size and motion.',
  accentLabel: 'Accent colour',
  accentHelp: 'Used by buttons, selection and focus tints. Contrast is recomputed for each theme.',
  accentCustom: 'Custom colour…',
  accentReset: 'Reset',
  presetAccentBlue: 'Blue',
  presetAccentCyan: 'Cyan',
  presetAccentMoss: 'Moss',
  presetAccentAmber: 'Amber',
  presetAccentClay: 'Clay',
  presetAccentIris: 'Iris',
  densityLabel: 'Density',
  densityHelp:
    'Row and toolbar heights. Compact also narrows the navigation and inspector columns — only widths you never dragged.',
  densityCompact: 'Compact',
  densityComfy: 'Comfy',
  uiFontSizeLabel: 'Interface text size',
  uiFontSizeHelp:
    'Covers the settings page, the cards and the navigation chrome; panel body text is still fixed size.',
  uiFontSizeNow: 'Current: {val}px',
  motionLabel: 'Motion',
  motionHelp:
    '"Follow system" honours the OS reduced-motion setting; "Off" removes transitions and animations regardless of it.',
  motionSystem: 'Follow system',
  motionOn: 'On',
  motionOff: 'Off',
  focusRingLabel: 'Focus ring',
  focusRingHelp: 'The outline the keyboard focus draws around a control.',
  statusShapesLabel: 'Distinguish status by shape',
  statusShapesHelp:
...
An invalid regex gets a red border and simply never fires; “Reset defaults” keeps your custom rules.`,
  ...
  wslDirPlaceholder: 'Linux path inside the distro (empty = home)',
  wslDistro: 'WSL distribution',
  wslDistroDefault: 'Default distribution',
  wslDistroHint: 'Leave empty for the default distribution',
  ...
  // Command snippets: connection grouping, params and options
  snippetGroupGeneral: 'General',
  snippetGroupUnknown: 'Unknown connection',
  snippetFilterActiveConnection: 'This connection only',
  snippetNoCommandsForConnection: 'No commands for this connection.',
  snippetParamsBadge: 'Parameters and options',
  snippetConnection: 'Connection',
  snippetParamSection: 'Parameters',
  snippetParamName: 'Name',
  snippetParamType: 'Type',
  snippetParamTypeText: 'Text',
  snippetParamTypeSelect: 'Select',
  snippetParamDefault: 'Default value',
  snippetParamOptions: 'Options (comma or newline separated)',
  ...
  snippetGroupByConnection: 'By connection',
  snippetGroupByCustom: 'By group',
  snippetGroupNew: 'New group',
  snippetGroupNewPlaceholder: 'Group name',
  snippetGroupExists: 'That group already exists',
  snippetGroupRename: 'Rename group',
  snippetGroupRenameMerge: 'That name already exists — renaming merges the two groups',
  snippetGroupDelete: 'Delete group',
  snippetGroupDeleteConfirm:
    'Delete the group "{name}"? Its commands move to "Ungrouped"; the commands themselves are kept.',
  snippetGroupEmptyHint:
    'No commands here yet — right-click a command to move it in, or drag one here.',
  snippetMoveToGroup: 'Move to group',
  snippetParamAdd: 'Add parameter',
  snippetParamRemove: 'Remove parameter',
  snippetParamOrphan: 'Not used in the command',
  snippetParamDuplicate: 'Duplicate parameter name: {name}',
  snippetParamNameInvalid:
    'Parameter name must start with a letter or underscore and contain only letters, digits, and underscores',
  snippetOptionSection: 'Options',
  snippetOptionText: 'Fragment',
  snippetOptionLabel: 'Label (optional)',
  snippetOptionValueType: 'Value',
  ...
  snippetOptionAdd: 'Add option',
  snippetOptionRemove: 'Remove option',
  snippetOptionMultiValueSlot: 'An option fragment may contain at most one value placeholder',
  snippetFillParamsTitle: 'Fill Parameters',
  snippetFillParamsDesc:
    'Set values and choose which items to include before sending to the terminal.',
  snippetFillToggle: 'Include',
  snippetFillResetItem: 'Reset to default',
  snippetFillResetAll: 'Reset all to defaults',
